...
\coverTitle[
font=\fontsize{26pt}{30pt}\songti\bfseries,
text width=\linewidth,align=flush right,red!50!RedViolet]
{二〇一九年历，再努力！}

\makeCover
% 由于须要以xelatex编译，封面变换了字体大小以后，会影响到后面英汉字符之间的距离，只好再强行加这一行来修正。
% \ifluatex
...
\event[mark style=holiday]{2019-01-01}{2}{元旦+补休}
\event[mark style=holiday]{2019-01-27}{2019-2-2}{春节连休}
...
\event[mark style=blue icon, marker=\faBriefcase]
{2019-02-04}{}{春节调休上班}
\event[mark style=pink icon,marker=\faBirthdayCake]{2019-02-14}{}{朋友生日}
\event{2019-02-22}{}{稿件死线！！}
\event{2019-02-28}{2019-03-02}{旅游去！}
...
% \illustration[这是实物]
% {6.5cm}{actual}
\otherstuff[今天我 寒夜里看雪飘过]
{8.5cm}{\huge 海阔天空}

\begin{monthCalendar}{2019}{03}
\event{2019-02-28}{2019-03-02}{旅游去！}

\event[mark style=holiday]{2019-03-08}{}{妇女节}

\event[mark style=blue icon,marker=\faBriefcase]{2019-03-10}{2019-03-15}{上海出差}
\end{monthCalendar}
