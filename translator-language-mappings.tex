...
\DeclareOption{bahasai}      {\trans@use@and@alias{bahasai} {Indonesian}}
\DeclareOption{bahasam}      {\trans@use@and@alias{bahasam} {Malaysian,BahasaMalaysia}}
\DeclareOption{melayu}      {\trans@use@and@alias{melayu} {Malaysian,BahasaMalaysia}}
\ProcessOptions*
