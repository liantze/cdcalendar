...
\monthTitleStyle{font={\fontsize{28pt}{28pt}\bfseries\sffamily}, text=RoyalBlue!40!white}
...
\illustration{\linewidth}{img/plasma01}
\begin{monthCalendar}{2024}{03}
\end{monthCalendar}

\clearpage

\illustration{\linewidth}{img/plasma02}
\begin{monthCalendar}{2024}{04}
\end{monthCalendar}

\clearpage

\illustration{\linewidth}{img/plasma03}
\begin{monthCalendar}{2024}{05}
\end{monthCalendar}

\clearpage

\illustration{\linewidth}{img/plasma04}
