...
\documentclass[12pt,nobabel,sundayweek,dvipdfmx]{cdcalendar}
...
\coverImage[\color{gray!50}\sffamily David R.~Goodsell, RCSB PDB, 2005. `Molecule of the Month 2005 August: Neurotrophins: Receptors for nerve growth factor'. \mbox{CC-BY-4.0.} \url{https://doi.org/10.2210/rcsb_pdb/mom_2005_8}]
...
\sundayColor{red}
\monthTitleStyle{font={\fontsize{42pt}{44pt}\sffamily\gtfamily}, red!50!RedViolet}
\eventStyle{\scriptsize\sffamily\gtfamily\selectfont}
...
\event[mark style=blue icon,marker=\faBriefcase]
{2019-01-30}{5}{ACME会議}
\event[mark style=pink icon,marker=\faBirthdayCake]
{2019-02-14}{}{友人の誕生日}
